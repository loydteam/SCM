...
<!--    <center>-->
        ...
        <br/><a href="/revision/NewFile/<?php echo $Args['file']->id; ?>/?i=<?php echo $Args['file']->id; ?>" class="new_files">New Version File</a><br/>
        <br/>
            ...
            <div class="files_info">
                ...
                <b class="green">Update Time:</b> <?php echo $val->update_time; ?><br/>
                    <div class="edit_files">
                        <a href="/Revision/GetFileInfo/<?php echo $val->id; ?>?i=<?php echo $Args['file']->id; ?>" >Show File</a><br/>
                        ...
                        <button class="revision-file-delete new-file-button" value="<?php echo $val->id; ?>">Delete This Version</button>
                    </div>
                <br/>
            </div>
            <?php
